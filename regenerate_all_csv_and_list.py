#!/usr/bin/env python3
"""
Regenerate all CSVs and ref_ids list in UAT environment.

Pipeline:
1. get_option_instruments.py (UAT) -> option_ref_ids_all.csv, option_ref_ids_filtered.csv
...
def main():
    print("Regenerating all CSVs and ref_ids list (UAT environment)")
    
    run("get_option_instruments.py", "Fetch instruments from Nubra UAT, save option_ref_ids_all.csv and option_ref_ids_filtered.csv")
